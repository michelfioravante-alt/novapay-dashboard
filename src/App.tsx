...
function App() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 flex flex-col">
      ...
      <header className="bg-slate-900/80 backdrop-blur-md border-b border-slate-800/60 sticky top-0 z-50 px-6 py-4 flex items-center justify-between shadow-md">
        <div className="flex items-center gap-3">
          <div className="h-10 w-10 rounded-xl bg-gradient-to-tr from-brand-700 to-brand-500 flex items-center justify-center shadow-lg shadow-brand-500/20">
            <span className="font-extrabold text-white text-lg tracking-wider">NP</span>
          </div>
          <div>
            <h1 className="text-lg font-bold text-white tracking-tight flex items-center gap-2">
              NovaPay <span className="text-xs font-semibold px-2 py-0.5 rounded-full bg-slate-800 text-slate-400 border border-slate-700">Painel Operacional</span>
            </h1>
            <p className="text-xs text-slate-400 font-medium">Controle de Fluxo e Qualidade Comercial</p>
          </div>
        </div>

        <div className="flex items-center gap-4">
          <div className="flex items-center gap-2.5 px-3 py-1.5 rounded-xl bg-slate-950/40 border border-slate-800/80">
          ...
          <button
            ...
            className="p-2.5 rounded-xl bg-slate-800/80 hover:bg-red-500/10 hover:border-red-500/30 text-slate-400 hover:text-red-400 border border-slate-700/50 transition-all duration-300"
      ...
      <footer className="bg-slate-900/30 border-t border-slate-900/60 py-4 px-6 text-center flex flex-col md:flex-row justify-between items-center gap-2 text-xs text-slate-500 font-medium">
        ...
        <p className="flex items-center gap-1.5">
          ...
          Sistema Operacional sob Controle de Processos (PDCA / Lean Sigma)
        </p>
      </footer>
    </div>
  );
